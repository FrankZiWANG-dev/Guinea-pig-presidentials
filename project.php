...
<h1 id="project-title">About the project</h1>
    ...
    <div id="project1">
        <div id="project-text1">
            <p>As a web developer trainee (at Becode Charleroi), I’m always looking original ways to express my growing skills.</p>
        </div>
        <img src="https://github.com/FrankZiWANG-dev/Guinea-pig-presidentials/blob/master/assets/images/Becode-logo.png?raw=true" alt="becode-logo" id="project-logo1">
    </div>
